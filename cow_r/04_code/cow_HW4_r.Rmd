...
# Read in metadata
- Fill in the correct file path to the cow metadata and copy your answer to your obsidian document. 
```{r}
...
- Fill in the correct file path to the shannon diversity data and copy your answer to your obsidian document.
```{r}
...
- - Fill in the correct file path to the beta diversity data and copy your answer to your obsidian document.
```{r}
